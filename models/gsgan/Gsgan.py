...
class Gsgan(Gan):
    def __init__(self, oracle=None):
        ...
        self.oracle_file = 'save/oracle_gsgan_' + self.start_time+str('.txt')
        self.generator_file = 'save/generator_gsgan_' + self.start_time+str('.txt')
        self.test_file = 'save/test_file_gsgan_' + self.start_time+str('.txt')
    ...
    def train_real(self, data_loc=None):
        ...
        self.log = open('experiment-log-gsgan-real_'+self.start_time+str('.csv'), 'w', 1)
